ntkrnlmp_types = {
  ...
  '_KTHREAD' : [ 0x320, {
    ...
    'ReservedFlags' : [ 0xf4, ['BitField', dict(start_bit = 2, end_bit = 32)]],
    ...
    'Process' : [ 0x200, ['pointer', ['_KPROCESS']]],
    'Affinity' : [ 0x208, ['unsigned long long']],
    'ApcStatePointer' : [ 0x210, ['array', 4, ['pointer', ['_KAPC_STATE']]]],
  ...
  '_ETHREAD' : [ 0x428, {
    ...
    'TerminationPort' : [ 0x350, ['pointer', ['_TERMINATION_PORT']]],
    'ReaperLink' : [ 0x350, ['pointer', ['_ETHREAD']]],
    ...
    'ImpersonationInfo' : [ 0x3a8, ['pointer', ['_PS_IMPERSONATION_INFORMATION']]],
    'IrpList' : [ 0x3b0, ['_LIST_ENTRY']],
    'TopLevelIrp' : [ 0x3c0, ['unsigned long long']],
    'DeviceToVerify' : [ 0x3c8, ['pointer', ['_DEVICE_OBJECT']]],
    'ThreadsProcess' : [ 0x3d0, ['pointer', ['_EPROCESS']]],
    ...
    'Terminated' : [ 0x414, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'DeadThread' : [ 0x414, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'HideFromDebugger' : [ 0x414, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'ActiveImpersonationInfo' : [ 0x414, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'SystemThread' : [ 0x414, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'HardErrorsAreDisabled' : [ 0x414, ['BitField', dict(start_bit = 5, end_bit = 6)]],
    'BreakOnTermination' : [ 0x414, ['BitField', dict(start_bit = 6, end_bit = 7)]],
    'SkipCreationMsg' : [ 0x414, ['BitField', dict(start_bit = 7, end_bit = 8)]],
    'SkipTerminationMsg' : [ 0x414, ['BitField', dict(start_bit = 8, end_bit = 9)]],
    'SameThreadPassiveFlags' : [ 0x418, ['unsigned long']],
    'ActiveExWorker' : [ 0x418, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'ExWorkerCanWaitUser' : [ 0x418, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'MemoryMaker' : [ 0x418, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'KeyedEventInUse' : [ 0x418, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'SameThreadApcFlags' : [ 0x41c, ['unsigned long']],
    'LpcReceivedMsgIdValid' : [ 0x41c, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'LpcExitThreadCalled' : [ 0x41c, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'AddressSpaceOwner' : [ 0x41c, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'OwnsProcessWorkingSetExclusive' : [ 0x41c, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'OwnsProcessWorkingSetShared' : [ 0x41c, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'OwnsSystemWorkingSetExclusive' : [ 0x41c, ['BitField', dict(start_bit = 5, end_bit = 6)]],
    'OwnsSystemWorkingSetShared' : [ 0x41c, ['BitField', dict(start_bit = 6, end_bit = 7)]],
    'OwnsSessionWorkingSetExclusive' : [ 0x41c, ['BitField', dict(start_bit = 7, end_bit = 8)]],
    'OwnsSessionWorkingSetShared' : [ 0x41d, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'ApcNeeded' : [ 0x41d, ['BitField', dict(start_bit = 1, end_bit = 2)]],
