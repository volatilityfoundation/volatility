nt_types = {
  ...
  '_KTHREAD' : [ 0x200, {
    ...
    'SystemThread' : [ 0x3c, ['BitField', dict(start_bit = 13, end_bit = 14)]],
    'Reserved' : [ 0x3c, ['BitField', dict(start_bit = 14, end_bit = 32)]],
    'MiscFlags' : [ 0x3c, ['long']],
    ...
    'VdmSafe' : [ 0xb8, ['BitField', dict(start_bit = 9, end_bit = 10)]],
    'UmsDispatched' : [ 0xb8, ['BitField', dict(start_bit = 10, end_bit = 11)]],
    'ReservedFlags' : [ 0xb8, ['BitField', dict(start_bit = 11, end_bit = 32)]],
  ...
  '_ETHREAD' : [ 0x2b8, {
    ...
    'Reserved' : [ 0x280, ['BitField', dict(start_bit = 4, end_bit = 5)]],
