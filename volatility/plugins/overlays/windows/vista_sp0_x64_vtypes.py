ntkrnlmp_types = {
  ...
  '_KPRCB' : [ 0x3a20, {
    ...
    'ParentNode' : [ 0x36c0, ['pointer', ['_KNODE']]],
    'MultiThreadProcessorSet' : [ 0x36c8, ['unsigned long long']],
    'MultiThreadSetMaster' : [ 0x36d0, ['pointer', ['_KPRCB']]],
  ...
  '_KTHREAD' : [ 0x330, {
    ...
    'Reserved' : [ 0x90, ['BitField', dict(start_bit = 7, end_bit = 32)]],
    'MiscFlags' : [ 0x90, ['long']],
  ...
  '_ETHREAD' : [ 0x450, {
    ...
    'PriorityRegionActive' : [ 0x422, ['BitField', dict(start_bit = 0, end_bit = 4)]],
  ...
  '_EPROCESS' : [ 0x3e8, {
    ...
    'SparePsFlags1' : [ 0x370, ['BitField', dict(start_bit = 30, end_bit = 32)]],
  ...
  '_PTE_QUEUE_POINTER' : [ 0x8, {
    'PointerPte' : [ 0x0, ['BitField', dict(start_bit = 0, end_bit = 48)]],
    'TimeStamp' : [ 0x0, ['BitField', dict(start_bit = 48, end_bit = 64)]],
    'Data' : [ 0x0, ['long long']],
} ],
  '__unnamed_140c' : [ 0x10, {
  ...
  '_MMWSL' : [ 0x488, {
    ...
    'NonDirectHash' : [ 0x40, ['pointer', ['_MMWSLE_NONDIRECT_HASH']]],
    'HashTableStart' : [ 0x48, ['pointer', ['_MMWSLE_HASH']]],
  ...
  '_MMSUPPORT' : [ 0x68, {
    ...
    'ExitEvent' : [ 0x50, ['pointer', ['_KEVENT']]],
  ...
  '_CONTROL_AREA' : [ 0x60, {
    ...
    'WaitingForDeletion' : [ 0x40, ['pointer', ['_MI_SECTION_CREATION_EVENT']]],
  ...
  '_TEB' : [ 0x1828, {
    ...
    'SpareSameTebBits' : [ 0x17ee, ['BitField', dict(start_bit = 8, end_bit = 16)]],
  ...
  '_PROCESSOR_POWER_STATE' : [ 0x138, {
    ...
    'IdleStates' : [ 0x8, ['pointer', ['PPM_IDLE_STATES']]],
    'LastTimeCheck' : [ 0x10, ['unsigned long long']],
    'LastIdleTime' : [ 0x18, ['unsigned long long']],
    'IdleTimes' : [ 0x20, ['PROCESSOR_IDLE_TIMES']],
    'IdleAccounting' : [ 0x40, ['pointer', ['PPM_IDLE_ACCOUNTING']]],
    'PerfStates' : [ 0x48, ['pointer', ['PPM_PERF_STATES']]],
    ...
    'PStateMaster' : [ 0xf8, ['pointer', ['_KPRCB']]],
  ...
  '_SHARED_CACHE_MAP' : [ 0x1c8, {
    ...
    'VolumeCacheMap' : [ 0x1b8, ['pointer', ['_VOLUME_CACHE_MAP']]],
  ...
  '_WMI_LOGGER_CONTEXT' : [ 0x350, {
    ...
    'GetCpuClock' : [ 0x108, ['pointer', ['void']]],
    'FileCounter' : [ 0x110, ['long']],
    'BufferCallback' : [ 0x118, ['pointer', ['void']]],
    ...
    'Persistent' : [ 0x31c, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'AutoLogger' : [ 0x31c, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'FsReady' : [ 0x31c, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'RealTime' : [ 0x31c, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'Wow' : [ 0x31c, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'KernelTrace' : [ 0x31c, ['BitField', dict(start_bit = 5, end_bit = 6)]],
    'NoMoreEnable' : [ 0x31c, ['BitField', dict(start_bit = 6, end_bit = 7)]],
    'RequestFlag' : [ 0x320, ['unsigned long']],
    'RequestNewFie' : [ 0x320, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'RequestUpdateFile' : [ 0x320, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'RequestFlush' : [ 0x320, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'RequestDisableRealtime' : [ 0x320, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'RequestDisconnectConsumer' : [ 0x320, ['BitField', dict(start_bit = 4, end_bit = 5)]],
  ...
  '_CMHIVE' : [ 0xb38, {
    ...
    'ViewLock' : [ 0x5e8, ['pointer', ['_FAST_MUTEX']]],
    'WriterLock' : [ 0x5f0, ['pointer', ['_FAST_MUTEX']]],
    ...
    'FileObject' : [ 0x648, ['pointer', ['_FILE_OBJECT']]],
    ...
    'SecurityCache' : [ 0x6a0, ['pointer', ['_CM_KEY_SECURITY_CACHE_ENTRY']]],
    'SecurityHash' : [ 0x6a8, ['array', 64, ['_LIST_ENTRY']]],
    'UnloadEventCount' : [ 0xaa8, ['unsigned long']],
    'UnloadEventArray' : [ 0xab0, ['pointer', ['pointer', ['_KEVENT']]]],
    'RootKcb' : [ 0xab8, ['pointer', ['_CM_KEY_CONTROL_BLOCK']]],
    'Frozen' : [ 0xac0, ['unsigned char']],
    'UnloadWorkItem' : [ 0xac8, ['pointer', ['_CM_WORKITEM']]],
  ...
  '__unnamed_18ee' : [ 0x4, {
    ...
    'Reserved' : [ 0x0, ['BitField', dict(start_bit = 2, end_bit = 32)]],
} ],
  ...
  '_PEB' : [ 0x368, {
    ...
    'SpareBits' : [ 0x3, ['BitField', dict(start_bit = 4, end_bit = 8)]],
    ...
    'ReservedBits0' : [ 0x50, ['BitField', dict(start_bit = 2, end_bit = 32)]],
    ...
    'FreeList' : [ 0x68, ['pointer', ['_PEB_FREE_BLOCK']]],
  ...
  '_MMSUPPORT_FLAGS' : [ 0x4, {
    ...
    'Reserved' : [ 0x1, ['BitField', dict(start_bit = 1, end_bit = 8)]],
    ...
    'Available' : [ 0x3, ['BitField', dict(start_bit = 2, end_bit = 8)]],
} ],
  '__unnamed_1a07' : [ 0x4, {
    'AsULONG' : [ 0x0, ['unsigned long']],
  ...
  'PPM_PERF_STATES' : [ 0x80, {
    ...
    'PStateHandler' : [ 0x30, ['pointer', ['void']]],
    'PStateContext' : [ 0x38, ['unsigned long long']],
    'TStateHandler' : [ 0x40, ['pointer', ['void']]],
    'TStateContext' : [ 0x48, ['unsigned long long']],
    'FeedbackHandler' : [ 0x50, ['pointer', ['void']]],
  ...
  '_MAPPED_FILE_SEGMENT' : [ 0x40, {
    ...
    'LastSubsectionHint' : [ 0x38, ['pointer', ['_MSUBSECTION']]],
} ],
  '_TEB64' : [ 0x1828, {
    'NtTib' : [ 0x0, ['_NT_TIB64']],
  ...
  '_ARBITER_INSTANCE' : [ 0x690, {
    ...
    'BusDeviceObject' : [ 0x130, ['pointer', ['_DEVICE_OBJECT']]],
    'ConflictCallbackContext' : [ 0x138, ['pointer64', ['void']]],
    'ConflictCallback' : [ 0x140, ['pointer', ['void']]],
  ...
  '_SYSTEM_POWER_STATE_CONTEXT' : [ 0x4, {
    ...
    'Reserved2' : [ 0x0, ['BitField', dict(start_bit = 21, end_bit = 32)]],
  ...
  '_PEB32' : [ 0x238, {
    ...
    'ReservedBits0' : [ 0x28, ['BitField', dict(start_bit = 2, end_bit = 32)]],
  ...
  '_MMPTE_HARDWARE_LARGEPAGE' : [ 0x8, {
    ...
    'PageFrameNumber' : [ 0x0, ['BitField', dict(start_bit = 21, end_bit = 40)]],
    'reserved2' : [ 0x0, ['BitField', dict(start_bit = 40, end_bit = 64)]],
} ],
  '_KUSER_SHARED_DATA' : [ 0x3b8, {
    ...
    'SystemDllRelocated' : [ 0x2f0, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'SpareBits' : [ 0x2f0, ['BitField', dict(start_bit = 5, end_bit = 32)]],
  ...
  '_SEGMENT' : [ 0x58, {
    ...
    'PrototypePte' : [ 0x48, ['pointer', ['_MMPTE']]],
  ...
  '_WHEA_PCIX_BUS_VALIDATION_BITS' : [ 0x8, {
    'ErrorStatusValid' : [ 0x0, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'ErrorTypeValid' : [ 0x0, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'BusIdValid' : [ 0x0, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'BusAddressValid' : [ 0x0, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'BusDataValid' : [ 0x0, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'CommandValid' : [ 0x0, ['BitField', dict(start_bit = 5, end_bit = 6)]],
    'RequestorIdValid' : [ 0x0, ['BitField', dict(start_bit = 6, end_bit = 7)]],
    'CompleterIdValid' : [ 0x0, ['BitField', dict(start_bit = 7, end_bit = 8)]],
    'TargetIdValid' : [ 0x0, ['BitField', dict(start_bit = 8, end_bit = 9)]],
  ...
  '_SEGMENT_FLAGS' : [ 0x8, {
    ...
    'Spare' : [ 0x0, ['BitField', dict(start_bit = 23, end_bit = 63)]],
    'Binary32' : [ 0x0, ['BitField', dict(start_bit = 63, end_bit = 64)]],
} ],
  '_EX_WORK_QUEUE' : [ 0x58, {
  ...
  '_TEB32' : [ 0xff8, {
    ...
    'SpareSameTebBits' : [ 0xfca, ['BitField', dict(start_bit = 8, end_bit = 16)]],
  ...
  '_KTM' : [ 0x380, {
    ...
    'TmRm' : [ 0x2a0, ['pointer', ['_KRESOURCEMANAGER']]],
  ...
  '_MMPTE_TRANSITION' : [ 0x8, {
    ...
    'Transition' : [ 0x0, ['BitField', dict(start_bit = 11, end_bit = 12)]],
    'PageFrameNumber' : [ 0x0, ['BitField', dict(start_bit = 12, end_bit = 40)]],
    'Unused' : [ 0x0, ['BitField', dict(start_bit = 40, end_bit = 64)]],
} ],
  ...
  '_WHEA_PERSISTENCE_INFO' : [ 0x8, {
    'Identifier' : [ 0x0, ['BitField', dict(start_bit = 0, end_bit = 16)]],
    'Length' : [ 0x0, ['BitField', dict(start_bit = 16, end_bit = 40)]],
    'Reserved' : [ 0x0, ['BitField', dict(start_bit = 40, end_bit = 46)]],
    'Attributes' : [ 0x0, ['BitField', dict(start_bit = 46, end_bit = 48)]],
    'Signature' : [ 0x0, ['BitField', dict(start_bit = 48, end_bit = 64)]],
} ],
  ...
  '_WHEA_PCIX_DEV_VALIDATION_BITS' : [ 0x8, {
    'ErrorStatusValid' : [ 0x0, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'IdInfoValid' : [ 0x0, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'MemoryNumberValid' : [ 0x0, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'IoNumberValid' : [ 0x0, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'RegisterDataPairValid' : [ 0x0, ['BitField', dict(start_bit = 4, end_bit = 5)]],
  ...
  '_SECTION_IMAGE_INFORMATION' : [ 0x40, {
    ...
    'Reserved' : [ 0x33, ['BitField', dict(start_bit = 3, end_bit = 8)]],
  ...
  '_POP_HIBER_CONTEXT' : [ 0x158, {
    ...
    'DumpStack' : [ 0x88, ['pointer', ['_DUMP_STACK_CONTEXT']]],
    'WakeState' : [ 0x90, ['pointer', ['_KPROCESSOR_STATE']]],
    'HiberVa' : [ 0x98, ['unsigned long long']],
    'HiberPte' : [ 0xa0, ['_LARGE_INTEGER']],
    'Status' : [ 0xa8, ['long']],
    'MemoryImage' : [ 0xb0, ['pointer', ['PO_MEMORY_IMAGE']]],
    'TableHead' : [ 0xb8, ['pointer', ['_PO_MEMORY_RANGE_ARRAY']]],
    ...
    'BootLoaderLogMdl' : [ 0x150, ['pointer', ['_MDL']]],
} ],
  ...
  '_MI_SYSTEM_PTE_TYPE' : [ 0x20, {
    ...
    'GlobalMutex' : [ 0x10, ['pointer', ['_KGUARDED_MUTEX']]],
