nt_types = {
  ...
  '_CM_KEY_CONTROL_BLOCK' : [ 0x50, {
    ...
    'KcbUserFlags' : [ 0x48, ['BitField', dict(start_bit = 0, end_bit = 4)]],
    'KcbVirtControlFlags' : [ 0x48, ['BitField', dict(start_bit = 4, end_bit = 8)]],
    'KcbDebug' : [ 0x48, ['BitField', dict(start_bit = 8, end_bit = 16)]],
    'Flags' : [ 0x48, ['BitField', dict(start_bit = 16, end_bit = 32)]],
} ],
  '_KDPC' : [ 0x20, {
    'Type' : [ 0x0, ['short']],
