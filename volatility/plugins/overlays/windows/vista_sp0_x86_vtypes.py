nt_types = {
  ...
  '_KTHREAD' : [ 0x1e0, {
    ...
    'Reserved' : [ 0x68, ['BitField', dict(start_bit = 7, end_bit = 32)]],
    'MiscFlags' : [ 0x68, ['long']],
  ...
  '_ETHREAD' : [ 0x288, {
    ...
    'PriorityRegionActive' : [ 0x26a, ['BitField', dict(start_bit = 0, end_bit = 4)]],
  ...
  '_EPROCESS' : [ 0x270, {
    ...
    'SparePsFlags1' : [ 0x228, ['BitField', dict(start_bit = 30, end_bit = 32)]],
  ...
  '_WMI_LOGGER_CONTEXT' : [ 0x270, {
    ...
    'Persistent' : [ 0x244, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'AutoLogger' : [ 0x244, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'FsReady' : [ 0x244, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'RealTime' : [ 0x244, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'Wow' : [ 0x244, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'KernelTrace' : [ 0x244, ['BitField', dict(start_bit = 5, end_bit = 6)]],
    'NoMoreEnable' : [ 0x244, ['BitField', dict(start_bit = 6, end_bit = 7)]],
    'RequestFlag' : [ 0x248, ['unsigned long']],
    'RequestNewFie' : [ 0x248, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'RequestUpdateFile' : [ 0x248, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'RequestFlush' : [ 0x248, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'RequestDisableRealtime' : [ 0x248, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'RequestDisconnectConsumer' : [ 0x248, ['BitField', dict(start_bit = 4, end_bit = 5)]],
  ...
  '_SEGMENT_FLAGS' : [ 0x4, {
    ...
    'Spare' : [ 0x0, ['BitField', dict(start_bit = 23, end_bit = 32)]],
} ],
  '_EX_WORK_QUEUE' : [ 0x3c, {
  ...
  '_SECTION_IMAGE_INFORMATION' : [ 0x30, {
    ...
    'Reserved' : [ 0x23, ['BitField', dict(start_bit = 3, end_bit = 8)]],
