...
overlay = copy.deepcopy(vista_sp1_x64.overlay)

object_classes = copy.deepcopy(vista_sp1_x64.object_classes)

vtypes = copy.deepcopy(vista_sp2_x64_vtypes.ntkrnlmp_types)
