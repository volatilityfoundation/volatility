ntkrnlmp_types = {
  ...
  '_KTHREAD' : [ 0x360, {
    ...
    'Reserved' : [ 0x4c, ['BitField', dict(start_bit = 13, end_bit = 32)]],
    'MiscFlags' : [ 0x4c, ['long']],
    ...
    'ReservedFlags' : [ 0x100, ['BitField', dict(start_bit = 9, end_bit = 32)]],
  ...
  '_ETHREAD' : [ 0x498, {
    ...
    'SystemThread' : [ 0x448, ['BitField', dict(start_bit = 4, end_bit = 5)]],
  ...
  '_HARDWARE_PTE' : [ 0x8, {
    ...
    'PageFrameNumber' : [ 0x0, ['BitField', dict(start_bit = 12, end_bit = 40)]],
    'reserved1' : [ 0x0, ['BitField', dict(start_bit = 40, end_bit = 52)]],
