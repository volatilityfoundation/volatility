nt_types = {
  ...
  '_KTHREAD' : [ 0x1e0, {
    ...
    'KernelStackResident' : [ 0x68, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'ReadyTransition' : [ 0x68, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'ProcessReadyQueue' : [ 0x68, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'WaitNext' : [ 0x68, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'SystemAffinityActive' : [ 0x68, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'Alertable' : [ 0x68, ['BitField', dict(start_bit = 5, end_bit = 6)]],
    'GdiFlushActive' : [ 0x68, ['BitField', dict(start_bit = 6, end_bit = 7)]],
    'UserStackWalkActive' : [ 0x68, ['BitField', dict(start_bit = 7, end_bit = 8)]],
    'Reserved' : [ 0x68, ['BitField', dict(start_bit = 8, end_bit = 32)]],
    'MiscFlags' : [ 0x68, ['long']],
    ...
    'EtwStackTraceApc1Inserted' : [ 0xb0, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'EtwStackTraceApc2Inserted' : [ 0xb0, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'CycleChargePending' : [ 0xb0, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'CalloutActive' : [ 0xb0, ['BitField', dict(start_bit = 5, end_bit = 6)]],
    'ApcQueueable' : [ 0xb0, ['BitField', dict(start_bit = 6, end_bit = 7)]],
    'EnableStackSwap' : [ 0xb0, ['BitField', dict(start_bit = 7, end_bit = 8)]],
    'GuiThread' : [ 0xb0, ['BitField', dict(start_bit = 8, end_bit = 9)]],
    'ReservedFlags' : [ 0xb0, ['BitField', dict(start_bit = 9, end_bit = 32)]],
  ...
  '_ETHREAD' : [ 0x288, {
    ...
    'Terminated' : [ 0x260, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'ThreadInserted' : [ 0x260, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'HideFromDebugger' : [ 0x260, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'ActiveImpersonationInfo' : [ 0x260, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'SystemThread' : [ 0x260, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'HardErrorsAreDisabled' : [ 0x260, ['BitField', dict(start_bit = 5, end_bit = 6)]],
    'BreakOnTermination' : [ 0x260, ['BitField', dict(start_bit = 6, end_bit = 7)]],
    'SkipCreationMsg' : [ 0x260, ['BitField', dict(start_bit = 7, end_bit = 8)]],
    'SkipTerminationMsg' : [ 0x260, ['BitField', dict(start_bit = 8, end_bit = 9)]],
    'CopyTokenOnOpen' : [ 0x260, ['BitField', dict(start_bit = 9, end_bit = 10)]],
    'ThreadIoPriority' : [ 0x260, ['BitField', dict(start_bit = 10, end_bit = 13)]],
    'ThreadPagePriority' : [ 0x260, ['BitField', dict(start_bit = 13, end_bit = 16)]],
    'RundownFail' : [ 0x260, ['BitField', dict(start_bit = 16, end_bit = 17)]],
    'SameThreadPassiveFlags' : [ 0x264, ['unsigned long']],
    'ActiveExWorker' : [ 0x264, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'ExWorkerCanWaitUser' : [ 0x264, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'MemoryMaker' : [ 0x264, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'ClonedThread' : [ 0x264, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'KeyedEventInUse' : [ 0x264, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'RateApcState' : [ 0x264, ['BitField', dict(start_bit = 5, end_bit = 7)]],
    'SelfTerminate' : [ 0x264, ['BitField', dict(start_bit = 7, end_bit = 8)]],
    'SameThreadApcFlags' : [ 0x268, ['unsigned long']],
    'Spare' : [ 0x268, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'StartAddressInvalid' : [ 0x268, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'EtwPageFaultCalloutActive' : [ 0x268, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'OwnsProcessWorkingSetExclusive' : [ 0x268, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'OwnsProcessWorkingSetShared' : [ 0x268, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'OwnsSystemWorkingSetExclusive' : [ 0x268, ['BitField', dict(start_bit = 5, end_bit = 6)]],
    'OwnsSystemWorkingSetShared' : [ 0x268, ['BitField', dict(start_bit = 6, end_bit = 7)]],
    'OwnsSessionWorkingSetExclusive' : [ 0x268, ['BitField', dict(start_bit = 7, end_bit = 8)]],
    'OwnsSessionWorkingSetShared' : [ 0x269, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'OwnsProcessAddressSpaceExclusive' : [ 0x269, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'OwnsProcessAddressSpaceShared' : [ 0x269, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'SuppressSymbolLoad' : [ 0x269, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'Prefetching' : [ 0x269, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'OwnsDynamicMemoryShared' : [ 0x269, ['BitField', dict(start_bit = 5, end_bit = 6)]],
    'OwnsChangeControlAreaExclusive' : [ 0x269, ['BitField', dict(start_bit = 6, end_bit = 7)]],
    'OwnsChangeControlAreaShared' : [ 0x269, ['BitField', dict(start_bit = 7, end_bit = 8)]],
    'Spare1' : [ 0x26a, ['BitField', dict(start_bit = 0, end_bit = 8)]],
  ...
  '_EPROCESS' : [ 0x270, {
    ...
    'ExceptionPortState' : [ 0xd8, ['BitField', dict(start_bit = 0, end_bit = 3)]],
    ...
    'JobNotReallyActive' : [ 0x224, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'AccountingFolded' : [ 0x224, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'NewProcessReported' : [ 0x224, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'ExitProcessReported' : [ 0x224, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'ReportCommitChanges' : [ 0x224, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'LastReportMemory' : [ 0x224, ['BitField', dict(start_bit = 5, end_bit = 6)]],
    'ReportPhysicalPageChanges' : [ 0x224, ['BitField', dict(start_bit = 6, end_bit = 7)]],
    'HandleTableRundown' : [ 0x224, ['BitField', dict(start_bit = 7, end_bit = 8)]],
    'NeedsHandleRundown' : [ 0x224, ['BitField', dict(start_bit = 8, end_bit = 9)]],
    'RefTraceEnabled' : [ 0x224, ['BitField', dict(start_bit = 9, end_bit = 10)]],
    'NumaAware' : [ 0x224, ['BitField', dict(start_bit = 10, end_bit = 11)]],
    'ProtectedProcess' : [ 0x224, ['BitField', dict(start_bit = 11, end_bit = 12)]],
    'DefaultPagePriority' : [ 0x224, ['BitField', dict(start_bit = 12, end_bit = 15)]],
    'PrimaryTokenFrozen' : [ 0x224, ['BitField', dict(start_bit = 15, end_bit = 16)]],
    'ProcessVerifierTarget' : [ 0x224, ['BitField', dict(start_bit = 16, end_bit = 17)]],
    'StackRandomizationDisabled' : [ 0x224, ['BitField', dict(start_bit = 17, end_bit = 18)]],
    'AffinityPermanent' : [ 0x224, ['BitField', dict(start_bit = 18, end_bit = 19)]],
    'AffinityUpdateEnable' : [ 0x224, ['BitField', dict(start_bit = 19, end_bit = 20)]],
    'CrossSessionCreate' : [ 0x224, ['BitField', dict(start_bit = 20, end_bit = 21)]],
    'Flags' : [ 0x228, ['unsigned long']],
    'CreateReported' : [ 0x228, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'NoDebugInherit' : [ 0x228, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'ProcessExiting' : [ 0x228, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'ProcessDelete' : [ 0x228, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'Wow64SplitPages' : [ 0x228, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'VmDeleted' : [ 0x228, ['BitField', dict(start_bit = 5, end_bit = 6)]],
    'OutswapEnabled' : [ 0x228, ['BitField', dict(start_bit = 6, end_bit = 7)]],
    'Outswapped' : [ 0x228, ['BitField', dict(start_bit = 7, end_bit = 8)]],
    'ForkFailed' : [ 0x228, ['BitField', dict(start_bit = 8, end_bit = 9)]],
    'Wow64VaSpace4Gb' : [ 0x228, ['BitField', dict(start_bit = 9, end_bit = 10)]],
    'AddressSpaceInitialized' : [ 0x228, ['BitField', dict(start_bit = 10, end_bit = 12)]],
    'SetTimerResolution' : [ 0x228, ['BitField', dict(start_bit = 12, end_bit = 13)]],
    'BreakOnTermination' : [ 0x228, ['BitField', dict(start_bit = 13, end_bit = 14)]],
    'DeprioritizeViews' : [ 0x228, ['BitField', dict(start_bit = 14, end_bit = 15)]],
    'WriteWatch' : [ 0x228, ['BitField', dict(start_bit = 15, end_bit = 16)]],
    'ProcessInSession' : [ 0x228, ['BitField', dict(start_bit = 16, end_bit = 17)]],
    'OverrideAddressSpace' : [ 0x228, ['BitField', dict(start_bit = 17, end_bit = 18)]],
    'HasAddressSpace' : [ 0x228, ['BitField', dict(start_bit = 18, end_bit = 19)]],
    'LaunchPrefetched' : [ 0x228, ['BitField', dict(start_bit = 19, end_bit = 20)]],
    'InjectInpageErrors' : [ 0x228, ['BitField', dict(start_bit = 20, end_bit = 21)]],
    'VmTopDown' : [ 0x228, ['BitField', dict(start_bit = 21, end_bit = 22)]],
    'ImageNotifyDone' : [ 0x228, ['BitField', dict(start_bit = 22, end_bit = 23)]],
    'PdeUpdateNeeded' : [ 0x228, ['BitField', dict(start_bit = 23, end_bit = 24)]],
    'VdmAllowed' : [ 0x228, ['BitField', dict(start_bit = 24, end_bit = 25)]],
    'SmapAllowed' : [ 0x228, ['BitField', dict(start_bit = 25, end_bit = 26)]],
    'ProcessInserted' : [ 0x228, ['BitField', dict(start_bit = 26, end_bit = 27)]],
    'DefaultIoPriority' : [ 0x228, ['BitField', dict(start_bit = 27, end_bit = 30)]],
    'ProcessSelfDelete' : [ 0x228, ['BitField', dict(start_bit = 30, end_bit = 31)]],
    'SpareProcessFlags' : [ 0x228, ['BitField', dict(start_bit = 31, end_bit = 32)]],
  ...
  '_MMPAGING_FILE' : [ 0x50, {
    ...
    'PageFileNumber' : [ 0x38, ['BitField', dict(start_bit = 0, end_bit = 4)]],
    'BootPartition' : [ 0x38, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'Spare0' : [ 0x38, ['BitField', dict(start_bit = 5, end_bit = 16)]],
    'AdriftMdls' : [ 0x3a, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'Spare1' : [ 0x3a, ['BitField', dict(start_bit = 1, end_bit = 16)]],
  ...
  '_WMI_LOGGER_CONTEXT' : [ 0x280, {
    ...
    'Persistent' : [ 0x254, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'AutoLogger' : [ 0x254, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'FsReady' : [ 0x254, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'RealTime' : [ 0x254, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'Wow' : [ 0x254, ['BitField', dict(start_bit = 4, end_bit = 5)]],
    'KernelTrace' : [ 0x254, ['BitField', dict(start_bit = 5, end_bit = 6)]],
    'NoMoreEnable' : [ 0x254, ['BitField', dict(start_bit = 6, end_bit = 7)]],
    'RequestFlag' : [ 0x258, ['unsigned long']],
    'RequestNewFie' : [ 0x258, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'RequestUpdateFile' : [ 0x258, ['BitField', dict(start_bit = 1, end_bit = 2)]],
    'RequestFlush' : [ 0x258, ['BitField', dict(start_bit = 2, end_bit = 3)]],
    'RequestDisableRealtime' : [ 0x258, ['BitField', dict(start_bit = 3, end_bit = 4)]],
    'RequestDisconnectConsumer' : [ 0x258, ['BitField', dict(start_bit = 4, end_bit = 5)]],
  ...
  '_LOADER_PARAMETER_EXTENSION' : [ 0x84, {
    ...
    'BootViaWinload' : [ 0x58, ['BitField', dict(start_bit = 0, end_bit = 1)]],
    'Reserved' : [ 0x58, ['BitField', dict(start_bit = 1, end_bit = 32)]],
